...
typedef  void (*ConstraintFunction)(double[],int);
...
double simplex(CostFunction objfunc, double start[],int n, double EPSILON, double scale, ConstraintFunction constrain);
